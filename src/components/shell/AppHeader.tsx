        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          >
            ...
            <span className="min-w-0">
              <span className="block whitespace-nowrap font-[family-name:var(--font-display)] text-[15px] leading-none tracking-wide text-[color:var(--chalk)] sm:text-xl">
                Beat the Market
              </span>
            ...
            {user ? (
              <>
                <Link
                  ...
                  className="flex items-center gap-1.5 rounded-full border border-[color:var(--line)] bg-[color:var(--panel)]/60 p-1 transition hover:border-[color:var(--signal)]/40 sm:gap-2 sm:py-1 sm:pl-1 sm:pr-3"
                ...
                >
                  ...
                  <span className="hidden max-w-[9rem] truncate text-sm text-[color:var(--chalk)] sm:inline">
                    @{user.username}
                  </span>
                </Link>
                <SignOutButton />
